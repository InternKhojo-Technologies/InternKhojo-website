      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            sameAs: [
              "https://www.linkedin.com/company/internkhojo",
              "https://www.instagram.com/internkhojo",
              "https://x.com/internkhojo",
            ],
            foundingDate: "2026",
            areaServed: "IN",
          }),
          ...
          <Reveal>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-end">
              <div className="lg:col-span-7">
                ...
                <p className="text-sm md:text-base text-gray-400 font-normal leading-relaxed mt-4 md:mt-6 max-w-2xl">
                  InternKhojo is a free internship platform based in India that connects students and early-career professionals with vetted internship opportunities. Companies post verified roles, candidates apply directly with no cost, and every listing is manually checked for legitimacy, stipend transparency, and mentorship quality.
                </p>
              </div>
            ...
            return (
              <Reveal key={idx} delay={idx * 0.1}>
                <div className="p-8 md:p-10 bg-[#fafafa] rounded-[32px] md:rounded-[40px] hover:bg-white border border-transparent hover:border-gray-100 hover:shadow-2xl hover:shadow-red-500/5 transition-all duration-500 group h-full flex flex-col justify-between">
                  ...
                  <div>
                    <h3 className="text-xl md:text-2xl font-black mb-3 md:mb-4 uppercase tracking-tighter">
                      {item.title}
                    </h3>
                  ...
                  {[
                    {
                      ...
                      alt: "InternKhojo student builder in engineering",
                    },
                    {
                      src: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=80&h=80&fit=crop",
                      alt: "InternKhojo early-career professional in marketing",
                    },
                    {
                      src: "https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=80&h=80&fit=crop",
                      alt: "InternKhojo student builder in design",
                    },
                    {
                      src: "https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=80&h=80&fit=crop",
                      alt: "InternKhojo early-career professional in operations",
                    },
                  ].map((item, i) => (
                    <motion.div
                      key={i}
