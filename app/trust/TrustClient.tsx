...
const NAVIGATION_LINKS = [
  { name: "1. What We Do Not Allow", href: "#section-1" },
  { name: "2. Safety for Candidates", href: "#section-2" },
  { name: "3. Safety for Companies", href: "#section-3" },
  { name: "4. Candidate Information", href: "#section-4" },
  { name: "5. Report Suspicious Activity", href: "#section-5" },
  { name: "6. What InternKhojo May Do", href: "#section-6" },
  { name: "7. Account Verification", href: "#section-7" },
  { name: "8. Our Role in Safety", href: "#section-8" },
  { name: "9. Immediate Safety Concerns", href: "#section-9" },
  { name: "10. Policy Updates", href: "#section-10" },
  { name: "11. Contact Us", href: "#section-11" },
];
